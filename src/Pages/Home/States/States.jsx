        ...
        <div className='w-full my-32  px-5'>
            ...
            <div className="stats h-70    bg-gray-200  rounded-none shadow w-full">
                ...
                <div className="stat  p-6">
                    ...
                    <div className="text-xl  text-center font-extrabold ">Total Users</div>
                </div>
                ...
                <div className="stat p-6">
                    ...
                    <div className="text-xl  text-center font-extrabold ">Total Instructors</div>
                </div>
                ...
                <div className="stat p-6">
                    ...
                    <div className="text-xl  text-center font-extrabold ">Total Classes</div>
                </div>
                ...
                <div className="stat p-6">
                    ...
                    <div className="text-xl  text-center font-extrabold ">Total Students</div>
                </div>
