...
const Hero = () => {
    return (
        <div className='hero flex items-center flex-col-reverse md:flex-row  max-[700px]:h-[800px] h-[700px] '>


            <div className='w-full h-full flex flex-col justify-center    space-y-5  text-center '>
                <h1 className='text-7xl  text-bold tracking-wider   '>Music Planet</h1>
            ...
            <div className='w-full'>
                <Lottie className=' mx-auto opacity-90' animationData={hero} loop={true} />
            </div>
        </div>
    );
};
